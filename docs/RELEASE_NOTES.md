...
- Syncs now require review before changing task completion
- Added **Undo** for the most recently completed current task
- Improved handling for sequential and repeatable tasks
...
- Achievement Diaries now have their own category
...
- Fixed syncing and tracking issues for Tea Flask, Karamja Diary, and Giants' Foundry tasks
