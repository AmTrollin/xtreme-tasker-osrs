...
public class PrerequisiteTrackerServiceTest
{
    ...
    {
        PrerequisiteTrackerService partialService = serviceWithVarbitValue(Varbits.DIARY_KARAMJA_EASY, 1);
        ...
        PrerequisiteTrackerService completeService = serviceWithVarbitValue(Varbits.DIARY_KARAMJA_EASY, 10);
